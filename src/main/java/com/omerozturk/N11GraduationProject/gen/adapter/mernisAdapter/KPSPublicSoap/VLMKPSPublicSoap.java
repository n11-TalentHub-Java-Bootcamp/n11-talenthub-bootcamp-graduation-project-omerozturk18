...
public class VLMKPSPublicSoap
{
    ...
    public VLMKPSPublicSoap(){}

    public VLMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VLMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VLMExtendedSoapSerializationEnvelope envelope= new VLMExtendedSoapSerializationEnvelope(VLMExtendedSoapSerializationEnvelope.VER11);
