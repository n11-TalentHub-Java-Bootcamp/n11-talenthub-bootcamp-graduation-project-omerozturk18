...
public class VLMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VLMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VLMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VLMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VLMDateTimeConverter dateTimeConverter = new VLMStandardDateTimeConverter();

    public VLMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VLMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VLMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VLMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VLMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VLMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
