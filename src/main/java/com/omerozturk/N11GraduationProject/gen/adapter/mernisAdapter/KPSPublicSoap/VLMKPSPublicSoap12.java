package com.omerozturk.N11GraduationProject.gen.adapter.mernisAdapter.KPSPublicSoap;
...
public class VLMKPSPublicSoap12
{
    interface VLMIWcfMethod
    {
        VLMExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(VLMExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public VLMKPSPublicSoap12(){}

    public VLMKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public VLMKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected VLMExtendedSoapSerializationEnvelope createEnvelope()
    {
        VLMExtendedSoapSerializationEnvelope envelope= new VLMExtendedSoapSerializationEnvelope(VLMExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,VLMExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,VLMExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new VLMIWcfMethod()
        {
            @Override
            public VLMExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                VLMExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(VLMExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(VLMIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        VLMExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,VLMExtendedSoapSerializationEnvelope envelope)
    {
